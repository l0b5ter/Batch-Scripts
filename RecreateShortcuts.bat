...
if exist "%USERPROFILE%\Desktop\Chrome.lnk" (
    echo del "%USERPROFILE%\Desktop\Chrome.lnk"
    ...
    echo del "%USERPROFILE%\Desktop\Google Chrome.lnk"
	echo Set oWS = WScript.CreateObject("WScript.Shell") >> %SCRIPT%
	echo sLinkFile = "%USERPROFILE%\Desktop\Chrome.lnk" >> %SCRIPT%
	echo Set oLink = oWS.CreateShortcut(sLinkFile) >> %SCRIPT%
	if exist "%ProgramFiles(x86)%" (
    ...
    echo del "%USERPROFILE%\Desktop\Microsoft Edge.lnk"
	echo Set oWS = WScript.CreateObject("WScript.Shell") >> %SCRIPT%
    ...
    echo del "%USERPROFILE%\Desktop\Mozilla Firefox.lnk"
	echo Set oWS = WScript.CreateObject("WScript.Shell") >> %SCRIPT%
    ...
    echo del "%USERPROFILE%\Desktop\Firefox.lnk"
	echo Set oWS = WScript.CreateObject("WScript.Shell") >> %SCRIPT%
    ...
    echo del "%USERPROFILE%\Desktop\Internet Explorer Browser.lnk"
	echo Set oWS = WScript.CreateObject("WScript.Shell") >> %SCRIPT%
    ...
    echo del "%USERPROFILE%\Desktop\Internet Explorer.lnk"
	echo Set oWS = WScript.CreateObject("WScript.Shell") >> %SCRIPT%
    ...
    echo del "%USERPROFILE%\Desktop\Explorer.lnk"
	echo Set oWS = WScript.CreateObject("WScript.Shell") >> %SCRIPT%
    ...
    echo del "%USERPROFILE%\Desktop\Dropox.lnk"
	echo Set oWS = WScript.CreateObject("WScript.Shell") >> %SCRIPT%
